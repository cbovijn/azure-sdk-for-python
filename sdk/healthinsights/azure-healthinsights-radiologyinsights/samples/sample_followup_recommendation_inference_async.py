...
DESCRIPTION:
The sample_followup_recommendation_inference_async.py module processes a sample radiology document with the Radiology Insights service.
...
class HealthInsightsSamples:
    ...
    def display_followup_recommendation(self, radiology_insights_result):
        # [START display_followup_recommendation]
        ...
        # [END display_followup_recommendation]
