                ...
                if ri_inference.kind == models.RadiologyInsightsInferenceType.RADIOLOGY_PROCEDURE:
                    ...
                    for proccod in ri_inference.procedure_codes:
                        ...
                        for coding in proccod.coding:
                            print(f"{ri_inference.kind.name}: PROCEDURE CODES: Code: {coding.system} {coding.code} {coding.display}")  
                    ...
                    print(f"\n{ri_inference.kind.name}: ORDERED PROCEDURE:")
                    if orproc.description is not None:
                        print(f"{ri_inference.kind.name}: ORDERED PROCEDURE: Description: {orproc.description}")
                    if orproc.code is not None:
                        for coding in orproc.code.coding:
                            print(f"{ri_inference.kind.name}: ORDERED PROCEDURE: Code: {coding.system} {coding.code} {coding.display}")
